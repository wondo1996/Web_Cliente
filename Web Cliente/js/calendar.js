...
class CalendarYvv{
	...
	startElements(){
		...
		this.diasCoto = ["Lun", "Mar", "Mie", "Jue", "Vie", "Sáb", "Dom"];
	...
	createDaysMont(){
		...
		for(var i=0;i<this.cantDias;i++){
			...
			if(this.diasResal.indexOf(i+1)!=-1){
				div = $("<div class='evento d-flex border flex-fill w-100 justify-content-center pt-3 pb-3 btn "+this.btnD+"' data-date='"+fechNow+"' style='background: "+this.colorResal+"; color: "+this.textResalt+"; font-weight: bold;' onclick = 'redirigir()'>").html(i+1);
			}
